...
var balance
var items
var item_details = {1: [1, "Water Bottle", 10], 2: [1, "Backpack", 50], 3: [1, "Cart", 100],
                        ...
                        13: [1000, "Mansion", 10000000], 14: [3000, "Rocket", 100000000],
                        15: [5000, "Space Shuttle", 1000000000], 16: [10000, "Saturn V", 5000000000],
                        17: [100000, "Moon Landing", 25000000000],
                        18: [1000000, "McDonald's", 100000000000], 19: [10000000, "Apple", 1000000000000],
                        20: [50000000, "Fortune 500", 20000000000000],
                        21: [1000000000, "United States", 200000000000000],
                        22: [10000000000, "Everything on Earth", 1000000000000000],
                        23: [100000000000000000, "Earth", 100000000000000000]}
var income
var bonus_clicks
var can_list = []
var active_buyitem
...
var dataName = "game_data_c05c4c54";
...
function save_changes() {
    ...
    localStorage.setItem(dataName, btoa(JSON.stringify(data)));
}
...
function get_data() {
    ...
    if (data) {
        ...
        items = {1: false, 2: false, 3: false, 4: false, 5: false, 6: false, 7: false,
            ...
            22: false}
        decimal_digits = 3
        upgrade_details = {"income_boost": {levels: 25, costs: [100000, 1000000, 5000000, 10000000, 25000000, 50000000, 75000000, 100000000,
                                                                250000000, 500000000, 750000000, 1000000000, 5000000000, 10000000000, 50000000000, 100000000000,
                                                                250000000000, 500000000000, 750000000000, 1000000000000, 5000000000000, 10000000000000,
                            ...
                            "bonus_clicks": {levels: 50, costs: [1000, 10000, 50000, 100000, 500000, 1000000, 1500000, 2000000, 2500000, 3000000, 3500000,
                                                                    4000000, 4500000, 5000000, 7500000, 10000000, 15000000, 20000000, 25000000, 30000000, 35000000,
                                                                    40000000, 45000000, 50000000, 75000000, 100000000, 150000000, 200000000, 250000000, 300000000,
                                                                    350000000, 400000000, 450000000, 500000000, 750000000, 1000000000, 1500000000, 2000000000,
                                                                    2500000000, 3000000000, 3500000000, 4000000000, 4500000000, 5000000000, 7500000000, 10000000000,
...
function display_income_screen() {
    ...
    points_info += " (+" + prestige_points * 50 + "%)"
    ...
    if ((income_boosts + prestige_points) == 0) {
        ...
        total_boost_number.innerHTML = "+" + (prestige_points * 50 + ((1 + (5 * prestige_points) / 10) * income_boosts * 10)) + "%"
    }
...
function get_special_status(item) {
    if (item == 1) {
        return "You can afford a water bottle! ($10) (Income + 1)"
    } else if (item == 2) {
        return "You can afford a backpack! ($50) (Income + 1)"
    } else if (item == 3) {
        return "You can afford a cart to carry your possessions! ($100) (Income + 1)"
    } else if (item == 4) {
        return "You can afford a brand new bicycle! ($200) (Income + 2)"
    } else if (item == 5) {
        return "You can afford a new smartphone! ($750) (Income + 3)"
    } else if (item == 6) {
        return "You can afford a new gaming laptop! ($2,000) (Income + 3)"
    } else if (item == 7) {
        return "You can afford a large plasma TV! ($5,000) (Income + 5)"
    } else if (item == 8) {
        return "You can afford a good motorcycle! ($15,000) (Income + 10)"
    } else if (item == 9) {
        return "You can afford a brand new car! ($35,000) (Income + 15)"
    } else if (item == 10) {
        return "You can afford a new luxury car! ($100,000) (Income + 20)"
    } else if (item == 11) {
        return "You can afford an apartment in Manhattan! ($300,000) (Income + 50)"
    } else if (item == 12) {
        return "You can afford a house! ($1,000,000) (Income + 250)"
    } else if (item == 13) {
        return "You can afford a giant mansion! ($10,000,000) (Income + 1,000)"
    } else if (item == 14) {
        return "You can afford a rocket! ($100,000,000) (Income + 3,000)"
    } else if (item == 15) {
        return "You can afford a space shuttle! ($1,000,000,000) (Income + 5,000)"
    } else if (item == 16) {
        return "You can afford the Saturn V rocket! ($5,000,000,000) (Income + 10,000)"
    } else if (item == 17) {
        return "You can afford to go to the moon! ($25,000,000,000) (Income + 100,000)"
    } else if (item == 18) {
        return "You afford to buy McDonald's! ($100,000,000,000) (Income + 1,000,000)"
    } else if (item == 19) {
        return "You can afford to buy Apple! ($1,000,000,000,000) (Income + 10,000,000)"
    } else if (item == 20) {
        return "You can afford to buy every company on the Fortune 500! ($20,000,000,000,000) (Income + 50,000,000)"
    } else if (item == 21) {
        return "You can afford to buy the entire United States! ($200,000,000,000,000) (Income + 1,000,000,000)"
    } else if (item == 22) {
        return "You can afford to buy everything in the entire world! ($1,000,000,000,000,000) (Income + 10,000,000,000)"
    } else if (item == 23) {
        return "You afford to buy the planet Earth! ($100,000,000,000,000,000) (Income + 100,000,000,000,000,000)"
    } else {
    ...
    var loading_interval = setInterval(function() {
        ...
        if (typeof(balance) != "undefined" && typeof(bonus_clicks) != "undefined" && items && decimal_digits && upgrade_details && typeof(prestige_points) != "undefined") {
            ...
            if (upgrade_details["bonus_clicks"].levels == 36) {
                ...
                upgrade_details["bonus_clicks"].costs = [1000, 10000, 50000, 100000, 500000, 1000000, 1500000, 2000000, 2500000, 3000000, 3500000,
                                                            4000000, 4500000, 5000000, 7500000, 10000000, 15000000, 20000000, 25000000, 30000000, 35000000,
                                                            40000000, 45000000, 50000000, 75000000, 100000000, 150000000, 200000000, 250000000, 300000000,
                                                            350000000, 400000000, 450000000, 500000000, 750000000, 1000000000, 1500000000, 2000000000,
                                                            2500000000, 3000000000, 3500000000, 4000000000, 4500000000, 5000000000, 7500000000, 10000000000,
